...
app.layout = html.Div([
    ...
    html.H1('This is my Third dashboard'),
    html.H2('I\'m making an interactive plot'),
    html.H3('Here is our plot:'),
    html.Iframe(
    ...
    id='dd-chart-x',
    options=[
    # Label is what user sees, value is column
...
@app.callback(
    # Ouput set to iframe id -- in this case, 'plot'
    # Then call the srcDoc function
    dash.dependencies.Output('plot', 'srcDoc'),
    # Add a dropdown to select what will be on the x-axis
    [dash.dependencies.Input('dd-chart-x', 'value'),
    dash.dependencies.Input('dd-chart-y', 'value')])
    #Write function to update x-axis
